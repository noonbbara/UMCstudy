package com.example.demo1.apiPayload.code.status;

import com.example.demo1.apiPayload.code.BaseErrorCode;
import com.example.demo1.apiPayload.code.ErrorReasonDTO;
...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // Mission Error
    ALREADY_CHALLENGING_MISSION(HttpStatus.NOT_FOUND, "MISSION4001", "이미 도전 중인 미션입니다.");
